...
void TUnit_EncryptFile_Two_Recipients()
{
	std::string recipients[] = {"2FBbYE1xwzHoiXpxstHzeAQcDfJZKwdxWAGdaUKtnQ1gnN", "8FLEXeQ9nBGNy2sSKqfe97C4QtATyosbhHLzyvfBDxkGP"};

	std::string path = "tests/encryption_tests/";
	std::string fileName = "two_recipients_file";
	...
	size_t fileContentRandomSize = 100; // 100 random bytes
	...
	{
		printf("TUnit_EncryptFile_Two_Recipients: OK\n");
	}
	else
	{
		printf("TUnit_EncryptFile_Two_Recipients: FAILED\n");
