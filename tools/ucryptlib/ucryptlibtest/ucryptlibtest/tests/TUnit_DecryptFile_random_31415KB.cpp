...
void TUnit_DecryptFile_random_31415KB()
{
	std::string path = "tests/decryption_tests/";
	std::string fileName = "random_31415KB.encrypted";
	std::string fileNameDecrypted = path + "random_31415KB";
	std::string fileNameOriginal = path + "random_31415KB.original";
	...
	{
		printf("TUnit_DecryptFile_random_31415KB: OK\n");
	}
	else
	{
		printf("TUnit_DecryptFile_random_31415KB: FAILED\n");
