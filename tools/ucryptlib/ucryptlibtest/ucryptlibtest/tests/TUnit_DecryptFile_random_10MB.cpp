...
void TUnit_DecryptFile_random_10MB()
{
	std::string path = "tests/decryption_tests/";
	std::string fileName = "random_10MB.encrypted";
	std::string fileNameDecrypted = path + "random_10MB";
	std::string fileNameOriginal = path + "random_10MB.original";
	...
	{
		printf("TUnit_DecryptFile_random_10MB: OK\n");
	}
	else
	{
		printf("TUnit_DecryptFile_random_10MB: FAILED\n");
