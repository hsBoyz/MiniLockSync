...
void TUnit_EncryptFile_random_31415KB()
{
	std::string path = "tests/encryption_tests/";
	std::string fileName = "random_31415KB";
	...
	size_t fileContentRandomSize = 31415000; // 31415 KB random bytes
	...
	{
		printf("TUnit_EncryptFile_random_31415KB: OK\n");
	}
	else
	{
		printf("TUnit_EncryptFile_random_31415KB: FAILED\n");
