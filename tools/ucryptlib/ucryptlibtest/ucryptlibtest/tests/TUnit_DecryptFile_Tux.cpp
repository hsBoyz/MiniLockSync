...
void TUnit_DecryptFile_Tux()
{
	std::string path = "tests/decryption_tests/";
	std::string fileName = "2000px-Tux.svg.png.encrypted";
	std::string fileNameDecrypted = path + "2000px-Tux.svg.png";
	std::string fileNameOriginal = path + "2000px-Tux.svg.png.original";
	...
	{
		printf("TUnit_DecryptFile_Tux: OK\n");
	}
	else
	{
		printf("TUnit_DecryptFile_Tux: FAILED\n");
